namespace BookingSystem.Service.EmailTemplates
{
    public class EmailTemplateConst
    {
        public static string createOrder = @"<!DOCTYPE html>
<html>
  <head>
    <!--[if gte mso 9]>
      <xml>
        ...
        <tr style=""vertical-align: top"">
          ...
          >
            ...
            <div
              ...
              style=""padding: 0px; background-color: #34449a""
            >
              <div
                class=""u-row""
                style=""
                            ...
                            <tr>
                              ...
                              >
                                ...
                                >
                                  ...
                                  <p style=""font-size: 14px; line-height: 140%"">
                                    Preferences | Unsubscribe &nbsp;| View in
                                    browser
                                  </p>
                                </div>
                              </td>
