  ...
  return (
    <div className="my-12">
      <p className="mb-5 text-base text-gray-500 dark:text-gray-400 sm:text-lg lg:w-2/3 mx-auto text-center">
        ...
        mollis augue. Phasellus bibendum, metus quis ultricies commodo, est
        ligula interdum magna, id faucibus est velit id eros. Donec id metus nec
        nulla pharetra mattis eget vitae risus.
      </p>
